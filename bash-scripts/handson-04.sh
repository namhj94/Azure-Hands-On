...
az network vnet create --name vnet02 --resource-group handson --location eastus --address-prefix 192.168.0.0/16 --subnet-name subnet02 --subnet-prefix 192.168.1.0/26

# Create vnet peering
az network vnet peering create -n hjpeering --remote-vnet vnet02 -g handson --vnet-name vnet01 --allow-vnet-access
...
az network vnet subnet update --vnet-name vnet02 --name subnet02 -g handson --nsg hjnsg
